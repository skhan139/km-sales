...
<div className="info-box-container">
  <div className="info-box">
    ...
    <p className='intro'>
      ...
      <a href="/custom-game"> Visit our Custom Game Page</a> <br/> Are you a new customer and unsure of where to start? Ask our <a href="/chatbot"> Chatbot</a> about games and how to generate as much revenue for your club/event as possible!
    </p>
  </div>
</div>
