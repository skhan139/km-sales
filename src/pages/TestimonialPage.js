...
const TestimonialPage = () => {
  ...
  const testimonials = [
    ...
    { id: 6, name: "On-Site Customer Support", text: "We will attend your bash, fundraiser, or charity event and cater to any extra needs you may have. This includes brining extra inventory for the day, assisting with the distribution of any of our products, or any other of your needs to ensure you have a positive experience with us. Our goal is to make your fundriasing as efficient as possible and we are willing to help in any way that we can." },
  ];
