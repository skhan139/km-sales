...
import './LegacyPage.css'; // Import the updated CSS for styling

const LegacyPage = () => {
  return (
    <div className="legacy-page-shell">
      <h1 className="legacy-title">The Legacy Of Buzz Mills</h1>
      <p className="legacy-story">
        ...
        <br /><br />
        Throughout the decades, K&M Sales adapted to changing markets and embraced new technologies, but the core values instilled by Buzz remained unchanged. The company expanded its offerings, reaching new customers across the region. Each milestone was a testament to the hard work and commitment of the entire K&M family.
        <br /><br />
        Today, K&M Sales stands as a beacon of integrity and customer satisfaction. The legacy of Roy “Buzz” Mills lives on through the company's continued dedication to providing exceptional service. Every product delivered and every customer interaction reflects the principles that Buzz held dear.
        <br /><br />
